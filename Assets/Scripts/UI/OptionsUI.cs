...
public class OptionsUI : MonoBehaviour
{
    ...
    private void Start()
    {
        KitchenGameManager.Instance.OnGameUnpaused += KitchanGameManager_OnGameUnpaused;
        UpdateVisual();
    ...
    private void KitchanGameManager_OnGameUnpaused(object sender, System.EventArgs e)
    {
        Hide();
    }
